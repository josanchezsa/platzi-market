...
// OncePerRequestFilter es para que cada que se ejecute este filtro cada que se de una peticion
@Component
public class JwtFilterRequest extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if(authorizationHeader != null && authorizationHeader.startsWith("Bearer")){
            // se considera desde "Bearer" mas el espacio por eso el beginIndex es 7
            String jwt = authorizationHeader.substring(7);
            String username = jwtUtil.extractUserName(jwt);

            // esto para verificar que aun no haya niguna autenticacion para este usuario
